...
/// <summary>
/// Summary description for cls_connection_new
/// </summary>
public class cls_connection_new
{
    ...
    public void GetMail(string EmailID, string Subject, string Body)
    {
        ...
        NetworkCredential networkCredential = new NetworkCredential("smartworldapproval@gmail.com", "atqxijofxllkbctf");
    ...
    public void BindListBox(ListBox listBox, string sql, string TextField, string ValueField)
    {
        DataTable dt = new DataTable();
        dt = GetDataTable(sql);
