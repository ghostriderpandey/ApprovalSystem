<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListApproveCommitteePurchaseLogicNote.aspx.cs" Inherits="AdminPanel_ListApproveCommitteePurchaseLogicNote" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
                            ...
                            <div class="card-body px-0">
                                <div class="w-100">
                                    <asp:GridView ID="gvUser" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive  table-bordered" OnRowCommand="gvUser_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                     <a href="PurchaseLogicNoteReportCommittee.aspx?id=<%#Eval("PLNID") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye  ">
                                                        
                                                    </a>
                                                    <asp:LinkButton ID="lnkView" ToolTip="Click to view..!" runat="server" CommandName="View" CommandArgument='<%#Eval("PLNID") %>'><img src="Icons/view_16x16.png" /></asp:LinkButton>
