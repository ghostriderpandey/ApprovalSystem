<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="MiscellaneousLogicNoteReport.aspx.cs" Inherits="AdminPanel_MiscellaneousLogicNoteReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="row" style="border: 2px solid red">
        <table class="table table-bordered">
            <tr style="border: 1px solid red">
                <td colspan="12" class="text-center red font-weight-bold" style="background-color: #c0c0c0;"><b>Miscellaneous Logic Note</b></td>
            ...
            <tr>
                ...
                <td colspan="2"> Urgent Remarks</td>
                <td colspan="5">
            ...
            <tr>
                ...
                <td>Planned Award Date</td>
                <td colspan="2">
                    <asp:Label ID="lblpalnawardDate" runat="server" Text=""></asp:Label></td>
                <td>Actual Date of Award</td>
                <td colspan="5">
                    <asp:Label ID="lbldateofReward" runat="server" Text=""></asp:Label></td>
                </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="1">Approval Sought</td>
                <td>
    ...
    <div class="row" style="border: 2px solid">
        ...
        <table class="table table-bordered" runat="server" id="tblBidEvaluation">
            <tr>
                ...
                <td colspan="12">
                    <asp:GridView ID="gvItemHead" runat="server" ShowFooter="true" ShowHeaderWhenEmpty="True" CssClass="table table-bordered" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="V1Rate" HeaderText="V1Rate" />
                              <asp:BoundField DataField="V1Value" HeaderText="V1Value" />
                            <asp:BoundField DataField="V2Rate" HeaderText="V2Rate" />
                              <asp:BoundField DataField="V2Value" HeaderText="V2Value" />
                            <asp:BoundField DataField="V3Rate" HeaderText="V3Rate" />
                              <asp:BoundField DataField="V3Value" HeaderText="V3Value" />
        ...
        <table class="table table-bordered" runat="server" id="tblDeviation">
            <tr>
                        ...
                        <Columns>
                           ...
                           <%-- <asp:TemplateField HeaderText="Category">
                            ...
                            <asp:TemplateField HeaderText="DocFile">
                                <ItemTemplate>
                                   <asp:LinkButton ID="lnkAdd" runat="server" Text='<%# Eval("DocFile") %>' CommandArgument='<%# Eval("ID") + "," + Eval("MSLNID") + "," + Eval("DocFile")  %>' CommandName="Download" ToolTip="Download"></asp:LinkButton>

                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="DocImage">
                                <ItemTemplate>
                                   <asp:LinkButton ID="lnkDocImage" runat="server" Text='<%# Eval("DocImage") %>' CommandArgument='<%# Eval("ID") + "," + Eval("MSLNID") + "," + Eval("DocImage")  %>' CommandName="DownloadImage" ToolTip="Download Image"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <EmptyDataTemplate>
        ...
        <table class="table table-bordered">
            <tr>
                <td class="text-center red" style="background-color: #c0c0c0"><b>Miscellaneous Head</b></td>
                <td class="text-center red" style="background-color: #c0c0c0">Prepared By</td>
            </tr>
            <tr>
                <td rowspan="2">
                    <asp:TextBox ID="txtMiscellaneousHead" ReadOnly="true" runat="server" Rows="5" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                </td>
                <td>
