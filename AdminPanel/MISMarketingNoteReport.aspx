<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="MISMarketingNoteReport.aspx.cs" Inherits="AdminPanel_MISMarketingNoteReport" %>
...
<script>
    function fnn() {
        $('#<%= gvMISMarketingNoteReport.ClientID%>').prepend($("<thead></thead>").append($("#<%= gvMISMarketingNoteReport.ClientID%>").find("tr:first"))).DataTable({
            stateSave: true,
            "dom": 'Blfrtip',
            buttons: [
                {
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top:10px">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="">
                                    <asp:GridView ID="gvMISMarketingNoteReport" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="MLNOrderNo" HeaderText="Logic Note Approval No." />
                                            ...
                                            <asp:BoundField DataField="V1GrandTotal" HeaderText="Grand Total Amount" />
        ...
        <div class="modal-dialog" style="width: 830px;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" onclick="fnn();" data-dismiss="modal"> Close</button>
                </div>
            </div> 
        </div>
    </div>
