<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="MISPurchaseNoteReport.aspx.cs" Inherits="AdminPanel_MISPurchaseNoteReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        function fnn() {
            $('#<%= gvMISPurchaseNoteReport.ClientID%>').prepend($("<thead></thead>").append($("#<%= gvMISPurchaseNoteReport.ClientID%>").find("tr:first"))).DataTable({
                stateSave: true,
                "dom": 'Blfrtip',
                buttons: [
                    {
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top:15px">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="">                                                      
                                    <asp:GridView ID="gvMISPurchaseNoteReport" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="PLNOrderNo" HeaderText="Logic Note Approval No." />
                                            ...
                                            <asp:BoundField DataField="V1GrandTotal" HeaderText="Total Amount" />
