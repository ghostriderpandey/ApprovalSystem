...
public partial class AdminPanel_ListContractLogicNote : System.Web.UI.Page
{
    ...
    void loadgvUser()
    {
        ...
        dtData = cls.selectDataTable("EXEC sp_ManageContractLogicNote 'GetAll','" + dtUser.Rows[0]["ID"].ToString() + "'");
    ...
    protected void gvUser_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            int count = cls.ExecuteQuery("Exec sp_ManageContractLogicNote 'ChangeStatus','" + e.CommandArgument + "'");
            if (count > 0)
            {
        ...
        {
            int count = cls.ExecuteQuery("Exec sp_ManageContractLogicNote 'Delete','" + e.CommandArgument + "'");
            if (count > 0)
            {
        ...
        else if (e.CommandName == "View")
        {
            ...
            // Export.(e.CommandArgument.ToString());
            #region[CommentReportCode]
            //try
            //{
            //    string ReportType = "P";//
