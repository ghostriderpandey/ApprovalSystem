<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListApproveContractLogicNote.aspx.cs" Inherits="AdminPanel_ListApproveContractLogicNote" %>
                                    ...
                                    <asp:GridView ID="gvUser" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" runat="server" AutoGenerateColumns="False" CssClass="table  table-bordered table-responsive" OnRowCommand="gvUser_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <a href="ContractLogicNoteReport.aspx?id=<%#Eval("CLNID") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye">
