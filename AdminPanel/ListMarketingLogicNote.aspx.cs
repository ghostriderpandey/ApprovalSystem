...
public partial class AdminPanel_ListMarketingLogicNote : System.Web.UI.Page
{
    ...
    void loadgvUser()
    {
        ...
        dtData = cls.selectDataTable("EXEC sp_ManageMarketingLogicNote 'GetAll','" + dtUser.Rows[0]["ID"].ToString() + "'");
    ...
    protected void gvUser_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            int count = cls.ExecuteQuery("Exec sp_ManageMarketingLogicNote 'ChangeStatus','" + e.CommandArgument + "'");
            if (count > 0)
            {
        ...
        {
            int count = cls.ExecuteQuery("Exec sp_ManageMarketingLogicNote 'Delete','" + e.CommandArgument + "'");
            if (count > 0)
            {
        ...
        else if (e.CommandName == "ViewApprover")
        {
            string title = "";
            dtData = new DataTable();
            dtData = cls.selectDataTable("EXEC sp_ManageMarketingLogicNote 'GetAllApprover','" + e.CommandArgument + "'");
