<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="MISContractAmendmentReport.aspx.cs" Inherits="AdminPanel_MISContractAmendmentReport" %>
...
<script>
    function fnn() {
        $('#<%= gvMISContractAmendmentReport.ClientID%>').prepend($("<thead></thead>").append($("#<%= gvMISContractAmendmentReport.ClientID%>").find("tr:first"))).DataTable({
            stateSave: true,
            "dom": 'Blfrtip',
            buttons: [
                {
                    ...
                    titleAttr: 'Excel',
                    title: 'MISContractAmendmentReport'
                }
                //,
                //{
                //    extend: 'pdfHtml5',
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top:10px">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="">
                                    <asp:GridView ID="gvMISContractAmendmentReport" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ContractOrderNo" HeaderText="Contract No" />
                                            ...
                                            <asp:BoundField DataField="PreviousAmount" HeaderText="Previous Amount" />
                                            ...
                                            <asp:BoundField DataField="RevCostasperPrevious" HeaderText="Rev. Cost as per Previous Amendment" />
                                            <asp:BoundField DataField="RevCostasperThis" HeaderText="Rev. Cost as per this Amendment" />
