<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListViewApproveMarketingLogicNote.aspx.cs" Inherits="AdminPanel_ListViewApproveMarketingLogicNote" %>
                      ...
                      <Columns>
                          ...
                          <asp:TemplateField HeaderText="Approval Status">
                              <ItemTemplate>
                                  ...
                                  <a data-toggle="modal" data-target="#MyPopup" title="View this record" onclick="getApprover('<%#Eval("MLNID") %>')"><i class="fa fa-search"></i></a>
                              </ItemTemplate>
                          </asp:TemplateField>
                          ...
                          <asp:TemplateField HeaderText="Action">
                              <ItemTemplate>
                                  <a href="MarketingLogicNoteReport.aspx?Con=View&id=<%#Eval("MLNID") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye  "></a>
