<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListMarketingLogicNote.aspx.cs" Inherits="AdminPanel_ListMarketingLogicNote" %>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="w-100">
                                    <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive  table-bordered" OnRowCommand="gvUser_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lnkview" runat="server" CommandName="View" CommandArgument='<%#Eval("ID") %>' ToolTip="click to View PDF"><img src="Icons/view_16x16.png"  alt="view"/></asp:LinkButton>

                                                    <a href="MarketingLogicNote.aspx?id=<%#Eval("ID") %>" title="Edit this record">
