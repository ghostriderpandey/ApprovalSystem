<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ContractAmendmentLogicNoteReportCommittee.aspx.cs" Inherits="AdminPanel_ContractAmendmentLogicNoteReportCommittee1" %>
    ...
    <div class="row" style="border: 2px solid red">
        <table class="table table-bordered">
            <tr style="border: 1px solid red">
                <td colspan="12" class="text-center red font-weight-bold" style="background-color: #c0c0c0;"><b>Contract Amendment Logic Note</b> <asp:Label ID="lblorderno" runat="server" CssClass="font-weight-bold" Text=""></asp:Label></td>
            ...
            <tr>
                ...
                <td colspan="2"> <asp:Label ID="lblPurchaseOrderNo" runat="server" Text=""></asp:Label>
                   </td>
         ...
         <table class="table table-bordered">
            ...
            <tr>
                <td colspan="12">
                  ...
                  <%--                  <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "../Upload/CAN/"+ Eval("DocFile") %>' Text='<%# Eval("Category") %>'></asp:HyperLink>--%>
                                </ItemTemplate>
                            </asp:TemplateField>
