<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListViewApproveSalesLogicNote.aspx.cs" Inherits="AdminPanel_ListViewApproveSalesLogicNote" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Approval Status">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="btnView" runat="server" CommandName="ViewApprover" CommandArgument='<%#Eval("SLNID") %>' title="View this record">
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <a href="SalesLogicNoteReport.aspx?Con=View&id=<%#Eval("SLNID") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye  "></a>
                                                    <asp:LinkButton ID="lnkView" ToolTip="Click to view PDF..!" runat="server" CommandName="View" CssClass="fa fa-search" CommandArgument='<%#Eval("SLNID") %>'><%--<img src="Icons/view_16x16.png" />--%></asp:LinkButton>
