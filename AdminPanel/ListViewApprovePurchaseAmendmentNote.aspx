<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListViewApprovePurchaseAmendmentNote.aspx.cs" Inherits="AdminPanel_ListViewApprovePurchaseAmendmentNote" %>
        ...
        <div class="table-responsive">
            <asp:GridView ID="gvUser" runat="server" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive" OnRowCommand="gvUser_RowCommand">
                <Columns>
                    ...
                    <asp:BoundField DataField="PANOrderNo" HeaderText="Purchase AmendmentNo" />
                    ...
                    <asp:TemplateField HeaderText="Action">
                        <ItemTemplate>
                            <a href="PurchaseAmendmentReport.aspx?Con=View&id=<%#Eval("PANID") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye"></a>
