<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListViewApproveContractLogicNote.aspx.cs" Inherits="AdminPanel_ListViewApproveContractLogicNote" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Approval Status">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="btnView" runat="server" CommandName="ViewApprover" CommandArgument='<%#Eval("CLNID") %>' title="View this record">
                                         ...
                                         <%--   <asp:TemplateField HeaderText="Remark">
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <a href="ContractLogicNoteReport.aspx?Con=View&id=<%#Eval("CLNID") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye">                                                
                                                    </a>
                                                    <asp:LinkButton ID="lnkView" ToolTip="Click to view..!" runat="server" CommandName="View" CommandArgument='<%#Eval("CLNID") %>'><img src="Icons/view_16x16.png" /></asp:LinkButton>
