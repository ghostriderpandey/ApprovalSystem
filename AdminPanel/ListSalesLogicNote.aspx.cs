...
public partial class AdminPanel_ListSalesLogicNote : System.Web.UI.Page
{
    ...
    void loadgvUser()
    {
        ...
        dtData = cls.selectDataTable("EXEC sp_ManageSalesLogicNote 'GetAll','" + dtUser.Rows[0]["ID"].ToString() + "'");
    ...
    protected void gvUser_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            int count = cls.ExecuteQuery("Exec sp_ManageSalesLogicNote 'ChangeStatus','" + e.CommandArgument + "'");
            if (count > 0)
            {
        ...
        {
            int count = cls.ExecuteQuery("Exec sp_ManageSalesLogicNote 'Delete','" + e.CommandArgument + "'");
            if (count > 0)
            {
