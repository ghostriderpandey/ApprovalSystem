<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="MISContractNoteReport.aspx.cs" Inherits="AdminPanel_MISContractNoteReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        function fnn() {
            $('#<%= gvMISContractNoteReport.ClientID%>').prepend($("<thead></thead>").append($("#<%= gvMISContractNoteReport.ClientID%>").find("tr:first"))).DataTable({
                stateSave: true,
                "dom": 'Blfrtip',
                buttons: [
                    {
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top:10px">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="">
                                    <asp:GridView ID="gvMISContractNoteReport" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CLNOrderNo" HeaderText="Logic Note Approval No." />
