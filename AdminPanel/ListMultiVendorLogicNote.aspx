<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListMultiVendorLogicNote.aspx.cs" Inherits="AdminPanel_ListMultiVendorLogicNote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="w-100">
                                    <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" CssClass="table  table-bordered table-responsive" OnRowCommand="gvUser_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <a href="MultiVendorLogicNote.aspx?id=<%#Eval("ID") %>" title="Edit this record">
    ...
    <script>
        ...
        prm.add_endRequest(function () {
            $.when($.getScript("https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js")).then(function () { 
                fnn();
            });
        });
