<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="MISSalesNoteReport.aspx.cs" Inherits="AdminPanel_MISSalesNoteReport" %>
...
<script>
    function fnn() {
        $('#<%= gvMISSalesNoteReport.ClientID%>').prepend($("<thead></thead>").append($("#<%= gvMISSalesNoteReport.ClientID%>").find("tr:first"))).DataTable({
            stateSave: true,
            "dom": 'Blfrtip',
            buttons: [
                {
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top:10px">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="">
                                    <asp:GridView ID="gvMISSalesNoteReport" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SLNOrderNo" HeaderText="Logic Note Approval No." />
