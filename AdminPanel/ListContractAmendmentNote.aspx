<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListContractAmendmentNote.aspx.cs" Inherits="AdminPanel_ListContractAmendmentNote" %>
                                ...
                                <div class="w-100">
                                    <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" CssClass="table  table-bordered table-responsive" OnRowCommand="gvUser_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ContractOrderNo" HeaderText="ContractOrderNo" />
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <a href="ContractLogicNoteAmendment.aspx?id=<%#Eval("ID") %>" title="Edit this record">
