<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="MISPurchaseAmedmentReport.aspx.cs" Inherits="AdminPanel_MISPurchaseAmedmentReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script>
        function fnn() {
            $('#<%= gvMISPurchaseAmedmentReport.ClientID%>').prepend($("<thead></thead>").append($("#<%= gvMISPurchaseAmedmentReport.ClientID%>").find("tr:first"))).DataTable({
                stateSave: true,
                "dom": 'Blfrtip',
                buttons: [
                    {
                        ...
                        titleAttr: 'Excel',
                        title: 'MISPurchaseAmedmentReport'
                    }
                    //,
                    //{
                    //    extend: 'pdfHtml5',
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top:10px">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="">
                                    <asp:GridView ID="gvMISPurchaseAmedmentReport" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="PANOrderNo" HeaderText="Logic Note Approval No." />
                                              <asp:BoundField DataField="PurchaseOrderNo" HeaderText="PurchaseOrder No" />
                                            ...
                                            <asp:BoundField DataField="PreviousGrandTotal" HeaderText="Previous Amount" />
                                            <asp:BoundField DataField="AmendmentAmount" HeaderText="Amendment Amount" />
                                            <asp:BoundField DataField="OriginalAward" HeaderText="Cost as per original Award" />
                                            <asp:BoundField DataField="PreviousRevCost" HeaderText="Rev. Cost as per Previous Amendment" />
                                            <asp:BoundField DataField="ThisRevCost" HeaderText="Rev. Cost as per this Amendment" />
