<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListViewApproveContractAmendmentNote.aspx.cs" Inherits="AdminPanel_ListViewApproveContractAmendmentNote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
                                ...
                                <div class="w-100">
                                    <asp:GridView ID="gvUser" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive" OnRowCommand="gvUser_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CANOrderNo" HeaderText="Contract AmendmentNo" />
                                            ...
                                            <asp:BoundField DataField="ProposedVendor" HeaderText="Proposed Vendor" />
                                           ...
                                           <%-- <asp:TemplateField HeaderText="Remark">
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <a href="ContractAmendmentLogicNoteReport.aspx?Con=View&id=<%#Eval("ID") %>&AID=<%#Eval("CANID") %>" title="Click to view" class="fa fa-eye">
