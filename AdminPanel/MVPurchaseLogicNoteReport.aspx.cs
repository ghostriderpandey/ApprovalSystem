...
public partial class AdminPanel_MVPurchaseLogicNoteReport : System.Web.UI.Page
{
    ...
    {
        int count = cls.ExecuteQuery("Exec Sp_ManageApproval 'MVPLNApproverApprove','" + Request.QueryString["AID"].ToString() + "','" + txtremark.Text + "'");
        if (count > 0)
        {
    ...
    {
        int count = cls.ExecuteQuery("Exec Sp_ManageApproval 'MVPLNApproverReject','" + Request.QueryString["AID"].ToString() + "','" + txtremark.Text + "'");
        if (count > 0)
        {
