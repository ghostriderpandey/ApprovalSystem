<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ContractLogicNoteReportCommittee.aspx.cs" Inherits="AdminPanel_ContractLogicNoteReportCommittee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row" style="border: 2px solid">
        ...
        <%--                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "../Upload/CLN/"+ Eval("DocFile") %>' Text='<%# Eval("Category") %>'></asp:HyperLink>--%>
