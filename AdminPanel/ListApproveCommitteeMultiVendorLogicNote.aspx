<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListApproveCommitteeMultiVendorLogicNote.aspx.cs" Inherits="AdminPanel_ListApproveCommitteeMultiVendorLogicNote" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-5">
                                            <div class="form-group filetbtn">
                                                ...
                                                <br />
                                                <asp:Button ID="btnFilter" runat="server" Text="Filter" ValidationGroup="V" CssClass=" w-100 btn-success w-100" OnClick="btnFilter_Click" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <asp:GridView ID="gvUser" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" runat="server" AutoGenerateColumns="False" CssClass="table  table-bordered table-responsive" OnRowCommand="gvUser_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                     <a href="MVPurchaseLogicNoteReportCommittee.aspx?id=<%#Eval("MVPLNID") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye  ">
                                                        
                                                    </a>
                                                    <asp:LinkButton ID="lnkView" ToolTip="Click to view..!" runat="server" CommandName="View" CommandArgument='<%#Eval("MVPLNID") %>'><img src="Icons/view_16x16.png" /></asp:LinkButton>
