<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListApproveCommitteeMarketingLogicNote.aspx.cs" Inherits="AdminPanel_ListApproveCommitteeMarketingLogicNote" %>
                                    ...
                                    <asp:GridView ID="gvUser" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" runat="server" AutoGenerateColumns="False" CssClass="table  table-bordered table-responsive" OnRowCommand="gvUser_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <a href="MarketingLogicNoteReport.aspx?type=committe&id=<%#Eval("MLNID") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye  "></a>
                                                    <asp:LinkButton ID="lnkView" ToolTip="Click to view..!" runat="server" CommandName="View" CommandArgument='<%#Eval("MLNID") %>'><img src="Icons/view_16x16.png" /></asp:LinkButton>
