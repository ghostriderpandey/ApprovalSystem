<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListApprovePurchaseLogicNote.aspx.cs" Inherits="AdminPanel_ListApprovePurchaseLogicNote" %>
  ...
  <%--<asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanel1">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
                ...
                <div class="w-100">
                  <asp:GridView ID="gvUser" runat="server" ShowHeaderWhenEmpty="true"  EmptyDataText="No Record Found" AutoGenerateColumns="False" CssClass="table table-responsive  table-bordered" OnRowCommand="gvUser_RowCommand">
                    <Columns>
                    ...
                    <asp:BoundField DataField="ProjectName" HeaderText="Project Name" />
                        <asp:BoundField DataField="VendorName" HeaderText="Propose Vendor" />
                    ...
                    <asp:TemplateField HeaderText="Action">
                      <ItemTemplate> <a href="PurchaseLogicNoteReport.aspx?id=<%#Eval("Plnid") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye  "></a>
