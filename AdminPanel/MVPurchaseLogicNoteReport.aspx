<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="MVPurchaseLogicNoteReport.aspx.cs" Inherits="AdminPanel_MVPurchaseLogicNoteReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="row" style="border: 2px solid red">
        <table class="table table-bordered">
            <tr style="border: 1px solid red">
                <td colspan="15" class="text-center red font-weight-bold" style="background-color: #c0c0c0;"><b>Multiple Vendor Logic Note</b></td>
            ...
            <tr style="border: 1px solid red">
             ...
             <tr>
                ...
                <td colspan="2">
                    <asp:Label ID="lblApprovalNo" Visible="false" runat="server" Text=""></asp:Label></td>
            ...
            <tr>
                ...
                <td colspan="1"><strong><strong>Approve Budget<small>(inLacs)</small></strong></strong></td>
                <td colspan="1">
                    <asp:Label ID="lblapprovebudget" runat="server" Text=""></asp:Label></td>
                <td colspan="1"><strong>Already Awarded<small>(inLacs)</small></strong></td>
                <td colspan="1">
                    <asp:Label ID="lblalreadyawarded" runat="server" Text=""></asp:Label></td>
                <td colspan="2" style="background-color: #bfbfbf"><strong>Proposed Value of this award<small>(inLacs)</small></strong></td>
                ...
                <td colspan="2" id="tdvariationfrombudgetName" runat="server"><strong>Variation From Budget</strong></td>
            ...
            <tr>
                ...
                <td colspan="3"><strong>Reason of Variation</strong></td>
                <td colspan="2">
                ...
                <td colspan="2" id="tdnegotiationmodeName" runat="server"><strong>Negotiation Mode</strong></td>
                <td id="tdnegotiationmodeValue" runat="server" colspan="2">
                    <asp:Label ID="lblnegotiationmode" runat="server" Text=""></asp:Label></td>

            </tr>
            <tr>
                <td colspan="3"><strong>Proposed Vendor Name</strong></td>
                <td colspan="12">
            ...
            <tr>            
                ...
                <td colspan="2">
                 ...
                 <td colspan="2">Material Used By Date</td>
                <td colspan="4">
            ...
            <tr>
                ...
                <td colspan="7" class="text-center red" style="background-color: #00b0f0" id="tdbudgetapproval" runat="server" >
    ...
    <div class="row" style="border: 2px solid">
        <table class="table table-bordered">
            <tr>
                <td colspan="15" class="text-center red font-weight-bold" style="background-color: #c0c0c0"><b>Major deviation & recommendation in terms-conditions</b></td>
        ...
        <table class="table table-bordered table-responsive">
            ...
            <tr>
                <td colspan="12">
                    ...
                    <asp:GridView ID="gvItemHead" runat="server" ShowFooter="true" ShowHeaderWhenEmpty="True" CssClass="table table-bordered table-responsive" AutoGenerateColumns="False">
                    ...
                    <asp:GridView ID="gvAttachment" OnRowCommand="gvAttachment_RowCommand" runat="server" ShowHeaderWhenEmpty="True" CssClass="table table-bordered" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="DocFile">
                                <ItemTemplate>
                                      <asp:LinkButton ID="lnkAdd" runat="server" Text='<%# Eval("Category") %>' CommandArgument='<%# Eval("ID") + "," + Eval("MVPLNID") + "," + Eval("DocFile")  %>' CommandName="Download" ToolTip="Download File"></asp:LinkButton>
