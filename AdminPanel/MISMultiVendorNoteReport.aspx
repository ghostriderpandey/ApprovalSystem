<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="MISMultiVendorNoteReport.aspx.cs" Inherits="AdminPanel_MISMultiVendorNoteReport" %>
...
<script>
    function fnn() {
        $('#<%= gvMISMultiVendorNoteReport.ClientID%>').prepend($("<thead></thead>").append($("#<%= gvMISMultiVendorNoteReport.ClientID%>").find("tr:first"))).DataTable({
            stateSave: true,
            "dom": 'Blfrtip',
            buttons: [
                {
                    ...
                    titleAttr: 'Excel',
                    title: 'MISMultiVendorNoteReport'
                }
                //,
                //{
                //    extend: 'pdfHtml5',
                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top:10px">
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="">
                                    <asp:GridView ID="gvMISMultiVendorNoteReport" runat="server" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="MVPLNOrderNo" HeaderText="Logic Note Approval No." />
                                            <asp:BoundField DataField="ApprovalType" HeaderText="Type" />
                                            <asp:BoundField DataField="CommitteeName" HeaderText="Approval Athority" />
                                            ...
                                            <asp:BoundField DataField="VendorName1" HeaderText="Proposed Vendor (V1)" />
                                            <asp:BoundField DataField="V1GrandTotal" HeaderText="Total Amount (V1)" />
                                            <asp:BoundField DataField="VendorName2" HeaderText="Proposed Vendor (V2)" />
                                            <asp:BoundField DataField="V2GrandTotal" HeaderText="Total Amount (V2)" />
                                            <asp:BoundField DataField="VendorName3" HeaderText="Proposed Vendor (V3)" />
                                            <asp:BoundField DataField="V3GrandTotal" HeaderText="Total Amount (V3)" />
                                            <asp:BoundField DataField="VendorName4" HeaderText="Proposed Vendor (V4)" />
                                            <asp:BoundField DataField="V4GrandTotal" HeaderText="Total Amount (V4)" />
                                            <asp:BoundField DataField="IndentProponent" HeaderText="Indent Proponent" />
