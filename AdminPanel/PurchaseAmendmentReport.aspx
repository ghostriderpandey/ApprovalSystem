<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="PurchaseAmendmentReport.aspx.cs" Inherits="AdminPanel_PurchaseAmendmentReport" %>
     ...
     <div class="row" style="border: 2px solid red">
        <table class="table table-bordered">
            <tr style="border: 1px solid red">
                <td colspan="16" class="text-center red font-weight-bold" style="background-color: #c0c0c0;"><b>Purchase Amendment Logic Note</b></td>

            </tr>
            <tr style="border: 1px solid red">
                <td colspan="8" class="text-center red" style="background-color: #00b0f0">
            ...
            <tr>
                ...
                <td colspan="3">Material Needed by: </td>
                <td >
            ...
            <tr>
                ...
                <td style="background-color: #bfbfbf" colspan="5">Revised Value as per this amend<small>(inLacs)</small></td>
            ...
            <tr>
                ...
                <td colspan="2">Reason of Variation</td>
                <td colspan="2">
        ...
        <table class="table table-bordered">
            ...
            <tr>
             ...
             <tr>
              ...
              <tr>
                <td colspan="2" class="text-right">TCS</td>
                <td colspan="3">
