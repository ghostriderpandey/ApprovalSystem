<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.master" AutoEventWireup="true" CodeFile="ListViewApproveCRMLogicNote.aspx.cs" Inherits="AdminPanel_ListViewApproveCRMLogicNote" %>
                                    ...
                                    <asp:GridView ID="gvUser" runat="server" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" AutoGenerateColumns="False" CssClass="table table-responsive table-responsive" OnRowCommand="gvUser_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <a href="CRMLogicNoteReport.aspx?Con=View&id=<%#Eval("CRMID") %>&AID=<%#Eval("ID") %>" title="Click to view" class="fa fa-eye  "></a>
